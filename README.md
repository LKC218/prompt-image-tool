...
当前最新：[v2.5.23](https://github.com/LKC218/prompt-image-tool/releases/latest)

普通用户直接下载发布版，无需安装 Python 或前端依赖。

- [GitHub Releases](https://github.com/LKC218/prompt-image-tool/releases/latest)
- Windows：`PromptImageManager-Setup-2.5.23.exe`
- Android：`PromptImageManager-v2.5.23-Android.apk`（若该版本未附带 APK，请继续使用 Release 页中可用的最新 Android 包）
