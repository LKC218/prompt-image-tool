...
- `src/js/pc-utils.js`、`src/js/pc-utils-modal.test.js`、`src/js/release-notes.js`：PC 通用弹层与更新记录。通用弹层统一处理遮罩点击及 Escape 关闭，更新记录使用其打开和关闭接口。
