...
分类规范见 [`docs/README.md`](../README.md)。路径稳定目录：`技术文档/`、`构建方案/`、`版本记录/`、`模块说明/`、`assets/`。

| 目录 | 用途 |
| --- | --- |
| `docs/README.md` | 文档中心入口 |
| `docs/导航/` | 本文件（路径导航）+ 项目代码百科（概念说明） |
...
| `docs/工程指南/版本发布与更新记录维护指南.md` | 发版流程、版本号与配置同步 |
| `docs/计划与规格/` | 活跃实施计划 + compose-spec |
| `docs/质量与复盘/` | 测试记录、已修复问题、经验沉淀 |
| `docs/素材与提示词/` | 生图提示词与美术素材对照 |
| `docs/_归档/` | 已完成/过期材料，不参与日常导航 |
...
| `docs/_归档/` | 已完成计划、过程稿与历史整理方案，不参与日常导航 |
...
4. 中文文档命名：有意义、无空格、连字符分隔、日期后置 `YYMMDD`；长期规范类不带日期。
5. 新文档落点口诀见 [`docs/README.md`](../README.md)。
