...
3. 更新 `docs/导航/apps-code-map.md` 的相关导航。
...
8. `npm run build` 通过。
9. 文档已同步 `docs/导航/apps-code-map.md` 与 PC/移动端技术文档。
