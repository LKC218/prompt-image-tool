...
import { DEFAULT_SCAN_PORTS, DEFAULT_SYNC_PORT, formatLanAddress, LanScanner, LanSync, parseLanTarget } from '../sync/lan-sync.js';
import { buildExportSuccessMessage, exportBackup, getErrorMessage } from '../shared/backup-utils.js';
...
} from '../shared/prompt-tool-json-import.js';
import { renderVersionInfo } from '../core/version-info.js';
import { APPEARANCE_PREFERENCES, WORKBENCH_THEMES } from '../core/theme-config.js';
