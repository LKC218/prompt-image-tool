...
const sharedJs = readFileSync(resolve(process.cwd(), 'src/js/pc/pc-card-parallax.js'), 'utf8');
const goalProjectsJs = readFileSync(resolve(process.cwd(), 'src/js/pc/pc-goal-projects.js'), 'utf8');
const gamesHubJs = readFileSync(resolve(process.cwd(), 'src/js/pc/pc-games-hub.js'), 'utf8');
