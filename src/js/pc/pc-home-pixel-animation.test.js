...
const pcHomeJs = readFileSync(resolve(process.cwd(), 'src/js/pc/pc-home.js'), 'utf8');
const pcLibraryJs = readFileSync(resolve(process.cwd(), 'src/js/pc/pc-library.js'), 'utf8');
const pcCategoryJs = readFileSync(resolve(process.cwd(), 'src/js/pc/pc-category.js'), 'utf8');
const pcSettingsJs = readFileSync(resolve(process.cwd(), 'src/js/pc/pc-settings.js'), 'utf8');
const pcEditorJs = readFileSync(resolve(process.cwd(), 'src/js/pc/pc-editor.js'), 'utf8');
const pcDetailJs = readFileSync(resolve(process.cwd(), 'src/js/pc/pc-detail.js'), 'utf8');
const pcWelcomeBannerJs = readFileSync(resolve(process.cwd(), 'src/js/pc/pc-welcome-banner.js'), 'utf8');
