        ...
        sections: [
            {
                ...
                tone: 'blue',
                items: [
                    '更新确认更清晰：可选「暂不更新」或「下载安装」，取消后启动检查不再打扰该版本。',
                    '同一时间只允许一个更新任务，避免重复弹窗和重复下载。'
                ]
            },
            {
                title: '修复',
                tone: 'yellow',
                items: [
                    '更新确认框按 Esc 或点遮罩关闭后，「检查更新」按钮不再卡住。',
                    '下载过程中点「取消更新」不再因进度刷新而点不到。',
                    '安装到含空格路径时，静默覆盖安装目录不再失效。'
                ]
            },
            {
                title: '发布',
                tone: 'yellow',
                items: [
                    '版本号统一升级至 v2.5.19；发布 Windows Setup 安装包。'
                ]
            }
        ]
    },
        ...
        sections: [
            {
                ...
                tone: 'blue',
                items: [
                    '顶栏接缝对齐：窗口顶栏左段与侧栏同宽，竖线连成一条，不再错位断开。'
                ]
            },
            {
                title: '修复',
                ...
                items: [
                    ...
                    '去掉顶栏黑边：DWM 铺满窗口并隐藏残边，顶部不再出现约 6px 深色条。'
                ]
            },
            {
                title: '发布',
